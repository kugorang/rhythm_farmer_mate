...
// 앱 전체에 적용될 기본 TextTheme 정의
final appTextTheme = ShadTextTheme(
  h1: const TextStyle(fontFamily: 'HMFMMUEX'),
  h2: const TextStyle(fontFamily: 'HMFMMUEX'),
  h3: const TextStyle(fontFamily: 'HMFMMUEX'),
  h4: const TextStyle(fontFamily: 'HMFMMUEX'),
  p: const TextStyle(fontFamily: 'HMFMMUEX'),
  blockquote: const TextStyle(fontFamily: 'HMFMMUEX'),
  small: const TextStyle(fontFamily: 'HMFMMUEX'),
  lead: const TextStyle(fontFamily: 'HMFMMUEX'),
  large: const TextStyle(fontFamily: 'HMFMMUEX'),
  muted: const TextStyle(fontFamily: 'HMFMMUEX'),
);
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder<ThemeMode>(
      ...
      builder: (context, currentMode, child) {
        ...
        // 현재 테마 모드에 따라 동적으로 TextTheme의 색상 업데이트
